...
# -*- coding: utf-8 -*-
#
# shaman documentation build configuration file, created by
...
templates_path = ['shamantemplates']
...
latex_documents = [
    (master_doc, 'shaman.tex', 'shaman Documentation',
     'admin', 'manual'),
]
...
man_pages = [
    (master_doc, 'shaman', 'shaman Documentation',
     [author], 1)
]
...
texinfo_documents = [
    (master_doc, 'shaman', 'shaman Documentation',
     author, 'shaman', 'One line description of project.',
     'Miscellaneous'),
]
